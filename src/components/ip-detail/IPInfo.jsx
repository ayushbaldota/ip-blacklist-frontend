...
import { RefreshCw, Globe, AlertTriangle, Pencil } from 'lucide-react'
import StatusBadge from '../ips/StatusBadge'
import Button from '../common/Button'
import { TagList } from '../common/TagInput'
import EditIPModal from '../ips/EditIPModal'
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <p className="mt-1 font-medium">{ip.blacklist_count || ip.listings || 0}</p>
            </div>
          </div>
